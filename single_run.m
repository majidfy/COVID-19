...
%Ploting the trained model against real data
  ...
  hold on
  plot((30:45),S_loop_OH(30:45), 'LineWidth',3, 'LineStyle','--')
  hold on
  plot((1:45),S_loop_OH_True(1:45),'LineWidth',3)
...
ax.GridAlpha = 0.5;
  ...
  hold on
  plot((30:45),I_loop_OH(30:45), 'LineWidth',3, 'LineStyle','--')
  hold on
  plot((1:45),I_loop_OH_True(1:45),'LineWidth',3)
